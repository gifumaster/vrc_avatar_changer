...
export async function checkAvailableToken(_event, dto) {
...
export async function handleVRChatLogin(_event, dto) {
...
export async function handleTwoFactorAuth(_event, dto) {
...
export async function handleChangeAvatar(_event, dto) {
  const api_base = "https://api.vrchat.cloud/api/1";
  const endpoint = `/avatars/${dto.id}/select`;
  const url = `${api_base}${endpoint}`;
...
export async function handleTokenCheck(_event, dto) {
  const api_base = "https://api.vrchat.cloud/api/1";
  const endpoint = `/auth/user`;
  const url = `${api_base}${endpoint}`;
